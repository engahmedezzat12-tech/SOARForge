...
export default function HomePage() {
  ...
  <span
    title="Your role does not include admin console access"
    className="rounded-md border border-border/50 bg-muted/10 px-3 py-1.5 text-xs font-medium text-muted-foreground/50"
  >
    Admin Console
  </span>
)}
