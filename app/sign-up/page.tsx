...
function SignUpForm() {
  ...
  return (
    <form
      onSubmit={submit}
      className="w-full max-w-md rounded-2xl border border-border bg-card/70 p-8 shadow-xl"
    >
      <div className="mb-8">
        <SOARForgeLogo />
      </div>
...
export default function SignUpPage() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-background p-6 text-foreground">
      <Suspense
        fallback={
          <div className="w-full max-w-md rounded-2xl border border-border bg-card/70 p-8 text-sm text-muted-foreground shadow-xl">
            Loading invite...
          </div>
        }
      >
